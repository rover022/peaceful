...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.create = function () {
        ...
        for (var i = 0; i < 3; i++) {
            var a_x = xPos[i];
            var a_y = yPos[i];
            var apple = this.game.add.sprite(a_x, a_y, 'images');
        ...
        this.title = this.game.add.text(8, 8, '兔子钻洞:', { fill: 'red' });
        // this.title.font = "Press Start 2P";
        this.title.fontSize = 24;
        this.title.align = 'center';
        this.sub = this.game.add.text(4, 64, R.game_name + "\n ");
        ...
        this.press = this.game.add.text(0, this.game.height - 32, R.dian_start);
        // this.press.font = "微软雅黑";
        this.press.fontSize = 16;
        ...
        this.game.time.events.add(117330, function () {
            this.sfx.play('wind');
        }, this);
        //
        this.game.input.onDown.addOnce(function () {
            _this.bun.animations.play('wake');
            _this.bun.y -= 4;
            _this.starting = true;
        });
    };
    ...
    Menu.prototype.playScene = function () {
